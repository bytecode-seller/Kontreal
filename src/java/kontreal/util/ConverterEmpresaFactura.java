 ...
 * @author modima65
 */
@FacesConverter(value = "converterEmpresaFactura")
public class ConverterEmpresaFactura implements Converter, Serializable {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        FacturasBean bean = context.getApplication().evaluateExpressionGet(context, "#{facturasBean}", FacturasBean.class);
