...
public class Error {
    ...
    public final static String ERROR_SALDOS_A_INCOINCIDENTES = "Error, los saldos actuales no coinciden.";
    public final static String ERROR_SALDOS_I_INCOINCIDENTES = "Error, los saldos iniciales no coinciden.";
